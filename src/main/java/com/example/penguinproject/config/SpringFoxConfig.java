...
public class SpringFoxConfig {
    ...
    private ApiKey apiKey() {
        return new ApiKey(secretKey, Constants.TOKEN_HEADER, Constants.HEADER);
    }
    ...
    private List<SecurityReference> defaultAuth() {
        ...
        return Collections.singletonList(new SecurityReference(secretKey, authorizationScopes));
    }
